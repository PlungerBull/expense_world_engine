...
**Two parked product questions** (undecided design, ported from the deletion program's README before that transient directory was deleted — 2026-08-06). Everything below them is a closed record, kept for the dated history.
