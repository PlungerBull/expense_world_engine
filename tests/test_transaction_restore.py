...
the balance impact, re-activates cascaded hashtag junction rows, and
conditionally clears the reconciliation link based on the recon's
current state.

The tests below cover the four paths most likely to regress:
...
# ---------------------------------------------------------------------------
# 2. Cascaded hashtag junction restoration
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 3. Reconciliation unlink on completed-recon restore
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 4. Validation guard — archived account blocks restore, leaves state untouched
# ---------------------------------------------------------------------------
