...
# get_user_report_settings lived here until 2026-08-08; it moved to
# helpers/settings.py when balances joined reports as home-converting
# surfaces (bloat-audit §15) — the settings read is not report-specific.
